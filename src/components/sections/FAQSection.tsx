      ...
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="heading-lg mb-4">
            {t('Common ', '常见')}
            <span className="text-gradient">{t('Questions from Parents', '家长问题')}</span>
          </h2>
        </motion.div>
